...
public class EntityEvent_Generic : EntityEvent
{
    ...
    public void ElefataaEvent_Generic_Failed(EntityEvent levelEvent, EntityCharacterNPC2D1BitSwitch doorSwitch, CutsceneCamera m_elevatorEvent_Camera)
    {
        ...
        um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "M-Maaf, ada kesalahan teknis jadi tidak bisa kesana...", doorSwitch.voicePack))));
    ...
    {
        um.AddUIAction(() => { doorSwitch.SetExpression(Expression_2D1Bit.Cry); um.NextAction(); });
        um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "T-tapi buat kesana kamu butuh password...", doorSwitch.voicePack))));
        um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "M-mungkin Havva mengetahui passwordnya...", doorSwitch.voicePack),
        new DialogueChoice[2] {
            new DialogueChoice(passwordChoice, () => {
                ...
                doorSwitch.switchForDoors[0].EnterPassword(new PasswordChoice[] {
                    new PasswordChoice(2, elevata_downtown_answers_1 , new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, LocalizationManager.GENERIC_PASSWORD_QUESTION[0], doorSwitch.voicePack), haveKey),
                    new PasswordChoice(1, elevata_downtown_answers_2 , new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, LocalizationManager.GENERIC_PASSWORD_QUESTION[1], doorSwitch.voicePack), haveKey),
                    new PasswordChoice(0, elevata_downtown_answers_3 , new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, LocalizationManager.GENERIC_PASSWORD_QUESTION[2], doorSwitch.voicePack), haveKey),
                    new PasswordChoice(1, elevata_downtown_answers_4 , new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, LocalizationManager.GENERIC_PASSWORD_QUESTION[2], doorSwitch.voicePack), haveKey),
                },
                () => {
                    um.AddUIAction(() => { doorSwitch.SetExpression(Expression_2D1Bit.ThumbUp); um.NextAction(); });
    ...
    public void ElefataaEvent_Generic_Observatory(EntityEvent levelEvent, EntityCharacterNPC2D1BitSwitch doorSwitch, LocalizationString passwordChoice, bool haveKey, CutsceneCamera m_elevatorEvent_Camera, CutsceneCamera m_trappedEvent_Camera = null)
    {
        ...
        um.AddUIAction(() => StartCoroutine(um.DelayNextAction(1.0f)));
        um.AddUIAction(() => { doorSwitch.SetExpression(Expression_2D1Bit.Cry); um.NextAction(); });
        um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "M-maaf, kamu tidak bisa ke Observatory...", doorSwitch.voicePack))));
        um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "A-aslinya aku ga mau melakukan ini, t-tapi aku disuruh meminta password untuk siapapun yang ingin pergi ke Observatory agar tidak ada yang bisa menemui Havva...", doorSwitch.voicePack),
        new DialogueChoice[3] {
            new DialogueChoice(passwordChoice, () => {
                doorSwitch.switchForDoors[0].EnterPassword(new PasswordChoice[] {
                    ...
                    new PasswordChoice(2, new LocalizationString[3] {
                        ...
                        new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "D-dan terakhir, tolong isi captcha ini :", doorSwitch.voicePack), haveKey), 
                },
                () => {
                    um.AddUIAction(() => { player.animator.SetTrigger("interact"); um.NextAction(); });
                    um.AddUIAction(() => StartCoroutine(um.DelayNextAction(1.0f)));
                    um.AddUIAction(() => { doorSwitch.SetExpression(Expression_2D1Bit.ThumbUp); um.NextAction(); });
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "Passwordnya benar!", doorSwitch.voicePack))));
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "Ayo kita ke Observatory!", doorSwitch.voicePack))));
                    um.AddUIAction(() => { doorSwitch.UseSwitch(); um.NextAction(); });
                    um.AddUIAction(() => { StartCoroutine(GlobalGameManager.Instance.soundManager.FadeOutMusic(1.0f)); um.NextAction(); });
                    um.AddUIAction(() => StartCoroutine(um.DelayNextAction(1.0f)));
                    um.AddUIAction(() => StartCoroutine(um.AnimateTransition()));
            ...
            new DialogueChoice("Passwordnya dapat dimana ya?", () => {
                ...
                if(m_trappedEvent_Camera)
                {
                    ...
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "Y-yang setel passwordnya sih tadi ke arah timur laut...", doorSwitch.voicePack))));
                    um.AddUIAction(() => StartCoroutine(um.AnimateTransition()));
                    um.AddUIAction(() => { m_trappedEvent_Camera.UseCamera(); um.NextAction(); });
                    um.AddUIAction(() => StartCoroutine(um.AnimateTransition()));
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "S-Semoga saja... passwordnya engga dititipin ke " + passwordProtectorName + "...", doorSwitch.voicePack))));
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "Soalnya siapapun yang mendatangi " + passwordProtectorName + " akan dibakar!!!", doorSwitch.voicePack))));
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "Dan aku ga mau ada yang dibakar huaaaaaaaaaa!!!", doorSwitch.voicePack))));
                    um.AddUIAction(() => StartCoroutine(um.AnimateTransition()));
                ...
                {
                    um.AddUIAction(() => StartCoroutine(um.AddDialogue(new Dialogue(LocalizationManager.CHARACTER_2D1BIT_ELEFATAA, "Y-yang setel passwordnya terakhir kulihat di Havvatopia bagian Uptown...", doorSwitch.voicePack))));
                    um.AddUIAction(() => { doorSwitch.SetExpression(Expression_2D1Bit.None); um.NextAction(); });
                    um.AddUIAction(() => { levelEvent.RemoveBasicStatusEffectOnFinishEvent(); m_elevatorEvent_Camera.ReleaseCamera(); um.NextAction(); });
                }
            }),
